// Page pour renvoyer l'e‑mail de confirmation
...
<div class="card" in:fade>
  {#if sent}
    ...
    <p class="success">Si le compte existe, un e‑mail de confirmation a été envoyé.</p>
    <a href="#">Retour à la connexion</a>
  {:else}
    <h2>Renvoyer l'e‑mail de confirmation</h2>
    <label>
      Email
